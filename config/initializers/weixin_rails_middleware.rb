...
WeixinRailsMiddleware.configure do |config|
  ...
  config.public_account_class = "Site"
  ...
  # config.weixin_token_string = 'cfafe01063b6f03562b84ba3'
  # using to weixin server url to validate the token can be trusted.
  # config.weixin_secret_string = 'P3hKf8pda9-iueBynZJp4RdSiR-GHV-b'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = '771b5a82aa3db2291a66c4203715d2aaa8a2e321f8c'
